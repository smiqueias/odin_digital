...
import 'package:gtb_teatro/fonts.dart';
...
final class GtbFontSize {
  ...
  GtbFontSize({required this.xs_12, required this.xl_14, required this.sm_16, required this.md_32});

  GtbFontSize copyWith({double? xs_12, double? xl_14, double? sm_16, double? md_32}) {
    return GtbFontSize(
...
final class GtbFontWeight {
  ...
  GtbFontWeight({required this.regular, required this.bold, required this.semibold});

  GtbFontWeight copyWith({FontWeight? regular, FontWeight? bold, FontWeight? semibold}) {
...
final class GtbLineHeight {
  ...
  GtbLineHeight copyWith({double? small, double? large}) {
    return GtbLineHeight(small: small ?? this.small, large: large ?? this.large);
  }
}
...
final defaultTypography = GtbTypography(
  ...
  fontSize: GtbFontSize(xs_12: 12.0, xl_14: 14.0, sm_16: 16.0, md_32: 32.0),
